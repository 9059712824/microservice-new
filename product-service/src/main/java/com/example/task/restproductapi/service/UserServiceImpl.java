...
public class UserServiceImpl implements UserService{
    ...
    public UserDto updateUser(Long userId, UserDto userDto) {
        UserDto existingUserDto = getUserById(userId); // Retrieve existing user DTO
        User existingUser = convertToEntity(existingUserDto); // Convert existing user DTO to entity
        User user = convertToEntity(userDto); // Convert updated user DTO to entity

        // Update the existing user entity with data from the updated user entity
        ...
        return convertToDto(updatedUser); // Convert the updated user entity to UserDto
    }
